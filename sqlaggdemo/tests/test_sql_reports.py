...
from .reports import test_report, UserTestReport, RegionTestReport

import logging

logging.getLogger("sqlagg.query").setLevel(logging.DEBUG)
...
class ComplexReportTest(BaseReportTest):
